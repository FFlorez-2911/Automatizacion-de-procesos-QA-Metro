...
WebUI.click(findTestObject('Pagina inicial/Page_Metro de Medelln - Sea bienvenido/em_Adquisicin_bv'))
...
WebUI.click(findTestObject('Page_MedeMe - Adqcion - PdV -  Ajuste credito/Chechk credito'))
