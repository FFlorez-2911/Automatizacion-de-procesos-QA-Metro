...
WebUI.setText(findTestObject('Inicio de sesion - Cívica Calidad/Inicio de sesion_Civica Calidad/input_Cdula usuario_txtLogin'), findTestData('Usuarios/Usuarios login').getValue(1, 1))
